  ...
  <div id="wrapper">
    ...
    <div class="container-fluid">
      ...
      <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="tambah-anggota.php" class="d-none d-sm-inline-block btn btn-sm btn-info shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Tambah Anggota</a>
      </div>
              ...
              <tbody>
                ...
                ?>
                  <tr>
                    ...
                    <td><?= $data['nomorhp']; ?></td>
                    <td>
                      <a href="edit-anggota.php?id=<?= $data['id_anggota']; ?>" class="btn btn-info btn-icon-split btn-sm">
                        <span class="icon text-white-50">
                          <i class="fas fa-info-circle"></i>
                        </span>
                        <span class="text">Edit</span>
                      </a>
                      <a href="hapus-anggota.php?id=<?= $data['id_anggota']; ?>" class="btn btn-danger btn-icon-split btn-sm">
                        <span class="icon text-white-50">
  ...
  <script>
    $(document).ready(function() {
      $('#myTable').DataTable({
        ...
        buttons: [{
            extend: 'excelHtml5',
            title: 'Data Pendaftaran Anggota',
            exportOptions: {
              columns: [0, 1, 2, 3, 4, 5]
            }
          },
