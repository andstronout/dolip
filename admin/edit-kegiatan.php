...
<body id="page-top">
            ...
            <div class="card-body">
              <form method="post" enctype="multipart/form-data">
                <div class="mb-3">
                  ...
                  <input type="text" class="form-control" id="exampleInputName1" aria-describedby="nameHelp" placeholder="Masukan Judul Kegiatan Disini" name="namaKegiatan" value="<?= $sq['namaKegiatan']; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="exampleInputdate1" class="form-label">Tanggal Kegiatan</label>
                  <input type="date" class="form-control" id="exampleInputdate1" aria-describedby="dateHelp" placeholder="Masukan Tanggal Kegiatan" name="tanggal" value="<?= $sq['tanggal']; ?>" required>
                </div>
                <div class="mb-3">
                  <label for="exampleInputdeskripsi1" class="form-label">Deskripsi Kegiatan</label>
                  <textarea class="form-control" id="exampleInputdeskripsi1" placeholder="Masukan Deskripsi Kegiatan" name="deskripsi" rows="5" required><?= htmlspecialchars($sq['deskripsi']); ?></textarea>
                </div>
                <div class="mb-3">
  ...
  if (isset($_POST['simpan'])) {
    ...
    if (@$_FILES['gambar']['error'] > 0) {
      ...
      $sql = "UPDATE kegiatan SET namaKegiatan='$_POST[namaKegiatan]',tanggal='$_POST[tanggal]',deskripsi='$_POST[deskripsi]', gambar='$nama_gambar' WHERE id_kegiatan='$id'";
